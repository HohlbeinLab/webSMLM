...
back to the trace returns to whichever site was showing before. Deliberately
a "simple check" only for now: there is no donor/acceptor/FRET
channel assignment yet, just one curve per site.
